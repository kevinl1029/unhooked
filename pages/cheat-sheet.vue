...
/**
 * Cheat Sheet Page (Illusions Cheat Sheet)
 * Post-ceremony view of the illusions the user has seen through
 */
  ...
  <div class="min-h-screen py-8 px-4">
    <div class="max-w-2xl mx-auto">
      ...
      <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-white mb-2">Illusions Cheat Sheet</h1>
        <p class="text-white-65">Your quick reference guide</p>
      </div>

      <!-- Loading state -->
      <div v-if="pending" class="text-center py-12">
        <div class="inline-block animate-spin rounded-full h-8 w-8 border-4 border-brand-accent border-t-transparent" />
        <p class="mt-4 text-white-65">Loading your cheat sheet...</p>
      </div>

      <!-- Error state -->
      <div v-else-if="error" class="text-center py-12">
        <p class="text-red-400 mb-4">Failed to load cheat sheet</p>
        <button
      ...
      <div v-else-if="cheatSheet" class="space-y-6">
        ...
        <div
          ...
          class="glass rounded-card p-6 shadow-card border border-brand-border"
        >
        ...
        <div v-else class="text-center text-white-65 text-sm pt-4">
          <p>Complete your ceremony to finalize your cheat sheet</p>
        </div>
      </div>
    </div>
  </div>
